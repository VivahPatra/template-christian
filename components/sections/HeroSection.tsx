    ...
    <section ref={ref} className="relative min-h-screen xl:min-h-[220vh] flex flex-col items-center justify-start overflow-hidden pt-12 sm:pt-16 md:pt-20 lg:pt-14">
      ...
      >
        ...
        <motion.p variants={fadeUp}
          ...
          {weddingData.heroSubtitle || '✦   A Celebration of Love   ✦'}
        </motion.p>

        <motion.div variants={fadeUp} className="mb-2">
          <h1 className="font-display" style={{ fontSize: 'clamp(2rem, 6.5vw, 4.5rem)', lineHeight: 1.5, padding: '0.15em 0', color: '#fff', textShadow: '0 2px 20px rgba(0,0,0,0.12)' }}>
